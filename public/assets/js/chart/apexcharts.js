...
! function(t, e) {
      ...
      m = function() {
          ...
          return r(t, [{
              ...
              value: function(t) {
                  ...
                  return !L || A.globals.resized || A.globals.dataChanged ? !A.globals.resized && A.globals.dataChanged || C.showDelayedElements() : C.animatePathsGradually(e(e({}, X), {}, {
                      speed: g
                  })), A.globals.dataChanged && P && T && C.animatePathsGradually(e(e({}, X), {}, {
                      speed: u
                  })), z
              }
          }, {
      ...
      y = function() {
          ...
          return r(t, [{
              ...
              value: function(t, e) {
                  ...
                  return e.id && d.node.classList.add(x.escapeString(e.id)), d
              }
          }, {
      ...
      k = function() {
          ...
          return r(t, [{
              ...
              value: function(t, e, i) {
                  ...
                  return (this.getBaseLog(t, e) - s) / r
              }
          }, {
              key: "getLogYRatios",
              value: function(t) {
          ...
          return r(t, [{
              ...
              value: function(t, e) {
                  ...
                  if (this.annoCtx.invertAxis) {
                      ...
                      var n;
                      if (s.config.yaxis[e.yAxisIndex].logarithmic) n = (a = new k(this.annoCtx.ctx).getLogVal(a, e.yAxisIndex)) / s.globals.yLogRatio[e.yAxisIndex];
          ...
          return r(t, [{
              ...
              value: function(t, e, i) {
                  ...
                  for (var h, c = [], d = 0, g = 0; g <= t.seriesIndex; g++) {
                      ...
                      if (u)
                          for (var f = g + 1; f <= t.seriesIndex; f++) a.config.yaxis[f].seriesName === u && -1 === c.indexOf(u) && (d++, c.push(u))
                  }
                  if (a.config.yaxis[t.yAxisIndex].logarithmic) {
                      h = (n = new k(this.annoCtx.ctx).getLogVal(n, t.yAxisIndex)) / a.globals.yLogRatio[t.yAxisIndex]
                  } else {
                      var p = t.yAxisIndex + d;
                      h = (n - a.globals.minYArr[p]) / (a.globals.yRange[p] / a.globals.gridHeight)
                  }
                  if (r = a.globals.gridHeight - h - parseFloat(t.label.style.fontSize) - t.marker.size, o = a.globals.gridHeight - h, a.config.yaxis[t.yAxisIndex] && a.config.yaxis[t.yAxisIndex].reversed && (r = h + parseFloat(t.label.style.fontSize) + t.marker.size, o = h), x.isNumber(s)) {
                      var b = {
                              pSize: t.marker.size,
  ...
  var C = {
          ...
          return r(t, [{
              ...
              value: function(t, i) {
                  ...
                  for (var n = 0, l = 0; n < t.length; n++, l++) {
                      ...
                      this.ctx.series.addCollapsedClassToSeries(y, v), t[n].length > 0 && (this.visibleI = this.visibleI + 1);
                      var w = 0,
                          A = 0;
                      ...
                      f = S.y, w = S.barHeight, c = S.yDivision, g = S.zeroW, u = S.x, A = S.barWidth, h = S.xDivision, d = S.zeroH, this.horizontal || b.push(u + A / 2);
                      for (var C = s.group({
                          ...
                          this.isHorizontal ? (M = this.drawBarPaths(e(e({}, I), {}, {
                              ...
                              barWidth: A,
                              zeroH: d
                          })), w = this.series[n][P] / this.yRatio[this.yaxisIndex]);
                          ...
                          var E = this.barHelpers.getPathFillColor(t, n, P, v);
                          this.renderSeries({
                              realIndex: v,
                              pathFill: E,
                              j: P,
                      ...
                      a.globals.seriesXvalues[v] = b, a.globals.seriesYvalues[v] = p, o.add(y)
                  }
                  return o
              }
          }, {
              ...
              value: function(t) {
                  ...
                  var M = new E(this).handleBarDataLabels({
                      x: c,
                      y: d,
                      y1: g,
                      y2: u,
              ...
              value: function(t, i) {
                  ...
                  for (var r = s.group({
                      ...
                      for (var y = s.group({
                          ...
                          E && w.add(E), d = L.y, c = L.x;
                          var X = this.barHelpers.getPathFillColor(t, o, k, u),
      ...
      B = function() {
          function t(e) {
              a(this, t), this.ctx = e, this.w = e.w, this.twoDSeries = [], this.threeDSeries = [], this.twoDSeriesX = [], this.seriesGoals = [], this.coreUtils = new k(this.ctx)
          }
          return r(t, [{
              key: "isMultiFormat",
              value: function() {
              ...
              value: function(t, e, i) {
                  var a = [],
                      ...
                      n = new X(this.ctx).getActiveConfigSeriesIndex();
                  if ("array" === t) {
                              ...
                              if ("category" === o.config.xaxis.type || o.config.xaxis.convertedCatToNumeric)
                                  if (o.globals.isBarHorizontal) {
                                      var s = o.globals.yLabelFormatters[0],
                                          r = new X(e.ctx).getActiveConfigSeriesIndex();
              ...
              value: function(t, e) {
                  ...
                  if (!(t < 0 || t - 2 > i.globals.gridWidth)) {
                      ...
                      if ("top" === i.config.xaxis.position && (r = s - i.config.xaxis.axisTicks.height), i.config.xaxis.axisTicks.show) {
                          var o = new m(this.ctx).drawLine(t + i.config.xaxis.axisTicks.offsetX, s + i.config.xaxis.offsetY, a + i.config.xaxis.axisTicks.offsetX, r + i.config.xaxis.offsetY, i.config.xaxis.axisTicks.color);
      ...
      q = function() {
          ...
          return r(t, [{
              ...
              value: function(t, e, i) {
                  ...
                  var o = Math.abs(i - e);
                  if (r.logarithmic && o <= 5 && (a.invalidLogScale = !0), r.logarithmic && o > 5) a.allSeriesCollapsed = !1, a.yAxisScale[t] = this.logarithmicScale(e, i, r.logBase);
                  ...
                  if (0 !== a.responsive.length) {
                      ...
                      var r = new N({}),
                          o = function() {
                              ...
                              if (o > a) {
                                  var n = k.extendArrayProps(r, i.globals.initialConfig, i);
                                  t = x.extend(n, t), t = x.extend(i.config, t), e.overrideResponsiveOptions(t)
                              } else
                                  for (var l = 0; l < s.length; l++) o < s[l].breakpoint && (t = k.extendArrayProps(r, s[l].options, i), t = x.extend(i.config, t), e.overrideResponsiveOptions(t))
                          };
                      if (t) {
          ...
          return r(t, [{
              ...
              value: function() {
                  switch (this.w.config.theme.palette) {
                      case "palette1":
                          this.colors = ["#FFC60D", "#F68920", "#2B98D4", "#D8D8D8", "#000000"];
                          break;
                      case "palette2":
              ...
              value: function() {
                  ...
                  for (var o = e.globals.legendFormatter, n = e.config.legend.inverseOrder, l = n ? a.length - 1 : 0; n ? l >= 0 : l <= a.length - 1; n ? l-- : l++) {
                      ...
                      var p = e.config.legend.markers.offsetX,
                          ...
                          y = e.config.legend.markers.width,
                          w = e.config.legend.markers.strokeWidth,
      ...
      pt = function() {
          ...
          return r(t, [{
              ...
              value: function(t) {
                  ...
                  e.globals.isBarHorizontal && (s = new X(this.ctx).getActiveConfigSeriesIndex(!1, "desc") + 1);
                  ...
                  if (e.globals.isXNumeric ? (r && !d && (o -= a % 2 != 0 ? l / 2 : 0), r && d && e.globals.comboCharts && (o -= l / 2)) : e.globals.isBarHorizontal || (o = i.xAxisTicksPositions[t - 1] + i.dataPointsDividedWidth / 2, isNaN(o) && (o = i.xAxisTicksPositions[t] - i.dataPointsDividedWidth / 2)), e.globals.isBarHorizontal ? (n = n + e.config.grid.padding.top + h / 3) + h > e.globals.gridHeight && (n = e.globals.gridHeight - h) : e.config.tooltip.followCursor && (n = i.e.clientY - c.top - i.tooltipRect.ttHeight / 2), e.globals.isBarHorizontal || this.moveXCrosshairs(o), !i.fixedTooltip) {
              ...
              value: function(t) {
                  ...
                  if (e.target.classList.contains("apexcharts-".concat(r, "-rect"))) {
                      ...
                      if (o.tooltipLabels.drawSeriesTexts({
                          ...
                          a = n.globals.clientX - f.left - (a > n.globals.gridWidth / 2 ? o.tooltipRect.ttWidth : 0), s = n.globals.clientY - f.top
                      }
                  }
                  return {
                      x: a,
              ...
              value: function(t) {
                  ...
                  if (o) {
                      if (i.tooltipRect = {
                          ...
                          if (this.tConfig.onDatasetHover.highlightDataSeries) new X(e).toggleSeriesOnHover(s, s.target.parentNode);
          ...
          return r(i, [{
              ...
              value: function(t) {
                  ...
                  for (var p = f ? t.series.length - 1 : 0; f ? p >= 0 : p < t.series.length; f ? p-- : p++) {
                      ...
                      s.setSelectionFilter(M, 0, p), this.addListeners(M, this.radialDataLabels), b.add(M), M.attr({
                          index: 0,
                          j: p
                      });
                      var z = 0;
                      !this.initialAnim || e.globals.resized || e.globals.dataChanged || (z = e.config.chart.animations.speed), e.globals.dataChanged && (z = e.config.chart.animations.dynamicAnimation.speed), this.animDur = z / (1.2 * t.series.length) + this.animDur, this.animBeginArr.push(this.animDur), this.animatePaths(M, {
                          centerX: t.centerX,
                          centerY: t.centerY,
                          endAngle: S,
                          startAngle: w,
          ...
          return r(t, [{
              ...
              value: function(t, e, i) {
                  ...
                  if (a.config.chart.stacked)
                      for (var w = l.length; w > 0; w--) o.add(l[w - 1]);
                  else
              ...
              value: function(t) {
                  for (var e = t.series, i = t.realIndex, a = t.i, s = t.x, r = t.y, o = t.pX, n = t.pY, l = t.pathsFrom, h = t.linePaths, c = t.areaPaths, d = t.seriesIndex, g = t.lineYPosition, u = t.xArrj, f = t.yArrj, p = this.w, b = new m(this.ctx), v = this.yRatio, y = l.prevY, w = l.linePath, k = l.areaPath, A = l.pathFromLine, S = l.pathFromArea, C = x.isNumber(p.globals.minYArr[i]) ? p.globals.minYArr[i] : p.globals.minY, L = p.globals.dataPoints > 1 ? p.globals.dataPoints - 1 : p.globals.dataPoints, P = 0; P < L; P++) {
                      ...
                      if (p.globals.isXNumeric) {
                          var M = p.globals.seriesX[i][P + 1];
                          void 0 === p.globals.seriesX[i][P + 1] && (M = p.globals.seriesX[i][L - 1]), s = (M - p.globals.minX) / this.xRatio
      ...
      Ft = function() {
          ...
          return r(t, [{
              ...
              value: function(t, e) {
                  ...
                  if (s.comboCharts) {
                      ...
                      case "heatmap":
                          ...
                          break;
                      case "treemap":
                          x = new Et(this.ctx, e).draw(s.series);
                          break;
                      case "pie":
                      case "donut":
                      case "polarArea":
              ...
              value: function() {
                  ...
                  e.dom.elLegendForeign && e.dom.elLegendForeign.setAttribute("height", l), e.dom.elWrap.style.height = l + "px", m.setAttrs(e.dom.Paper.node, {
                      height: l
              ...
              switch (t[0]) {
                  ...
                  case "A":
                      t = (e = function(t, e) {
                          ...
                          s = (new SVG.Matrix).rotate(I).scale(1 / T, 1 / M).rotate(-I), F = F.transform(s), R = R.transform(s), r = [R.x - F.x, R.y - F.y], n = r[0] * r[0] + r[1] * r[1], o = Math.sqrt(n), r[0] /= o, r[1] /= o, l = n < 4 ? Math.sqrt(1 - n / 4) : 0, z === E && (l *= -1);
                          ...
                          for (k = 1, A = b.length; k < A; k++) S = (w = b[k - 1][2]).x, C = w.y, L = (w = b[k][0]).x, P = w.y, X = (w = b[k][1]).x, Y = w.y, H.push(["C", S, C, L, P, X, Y]);
                          return H
                      }(this.pos, t))[0]
              }
  ...
  var Ht = function() {
          ...
          return r(t, [{
              key: "initModules",
              value: function() {
                  this.ctx.publicMethods = ["updateOptions", "updateSeries", "appendData", "appendSeries", "toggleSeries", "showSeries", "hideSeries", "setLocale", "resetSeries", "zoomX", "toggleDataPointSelection", "dataURI", "addXaxisAnnotation", "addYaxisAnnotation", "addPointAnnotation", "clearAnnotations", "removeAnnotation", "paper", "destroy"], this.ctx.eventList = ["click", "mousedown", "mousemove", "mouseleave", "touchstart", "touchmove", "touchleave", "mouseup", "touchend"], this.ctx.animations = new b(this.ctx), this.ctx.axes = new K(this.ctx), this.ctx.core = new Ft(this.ctx.el, this.ctx), this.ctx.config = new N({}), this.ctx.data = new B(this.ctx), this.ctx.grid = new U(this.ctx), this.ctx.graphics = new m(this.ctx), this.ctx.coreUtils = new k(this.ctx), this.ctx.crosshairs = new tt(this.ctx), this.ctx.events = new J(this.ctx), this.ctx.exports = new j(this.ctx), this.ctx.localization = new Q(this.ctx), this.ctx.options = new L, this.ctx.responsive = new et(this.ctx), this.ctx.series = new X(this.ctx), this.ctx.theme = new it(this.ctx), this.ctx.formatters = new V(this.ctx), this.ctx.titleSubtitle = new at(this.ctx), this.ctx.legend = new ct(this.ctx), this.ctx.toolbar = new dt(this.ctx), this.ctx.dimensions = new lt(this.ctx), this.ctx.updateHelpers = new Rt(this.ctx), this.ctx.zoomPanSelection = new gt(this.ctx), this.ctx.w.globals.tooltip = new mt(this.ctx)
              }
          }]), t
      }(),
      Dt = function() {
