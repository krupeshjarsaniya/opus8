...
<section class="remedy-layout-wrapper">
    <div class="container">
        <h1 class="text-center">PSL<b class="">s</b></h1>
        <div class="row mt-5">
        	<div class="col-lg-3 px-4"><h5>Agent</h5></div>
        	<div class="col-lg-3 px-4"><h5>New on Board</h5></div>
        	<div class="col-lg-3 px-4"><h5>Sector</h5></div>
        	<div class="col-lg-3 px-4"><h5>Company</h5></div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/opus8/resources/views/agent-backend.blade.php ENDPATH**/ ?>