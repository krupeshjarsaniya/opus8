    ...
    <div class="container">
        ...
        <div id="app">
          <div id="industry_chart">
            <div class="chart_image text-center">
                <img src="{{ $agentImage->agent->getProfilePicAttribute() ?? asset('assets/images/avatar-img.png') }}" />
                <label class=""><h5>{{ $agentImage->agent->first_name }}</h5></label>
            </div>
