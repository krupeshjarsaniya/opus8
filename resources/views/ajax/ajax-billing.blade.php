        ...
        <form action="#" class="row" onsubmit="return false" method="post" name="Form_Name_{{ $value->first_name }}_{{ $value->id }}"  id="Form_Name_{{ $value->first_name }}_{{ $value->id }}">
            ...
            <div class="col-lg-3 px-3 bg-2 form-group mt-2">
                <div class="remedy-input-icon-wrapper">
                    <input type="text" class="form-control" name="weekly_billing" value="{{ $value->billings->weekly_billing ?? '' }}" placeholder="">
                </div>
            </div>
            <div class="col-lg-3 px-3 bg-2 form-group mt-2">
                <div class="remedy-input-icon-wrapper">
                    <input type="text" class="form-control" name="average_close_out" value="{{ $value->billings->average_close_out ?? '' }}" placeholder="">
                </div>
            </div>
            <div class="col-lg-3 px-3 bg-2 form-group mt-2">
