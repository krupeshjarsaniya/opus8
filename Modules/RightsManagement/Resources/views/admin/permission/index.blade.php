            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table id="permission-datatable" class="table table-striped table-hover w-100">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Name</th>
            ...
            columns: [
				...
				},
				{
                    ...
                    render:function(o){
						...
						element +=  '<button class="btn btn-danger btn-xs" title="Delete" onclick="deletePermission(' + o.id + ')"><i class="fa fa-trash"></i></button>';
						element +=  '</div>';
                        return element;
                    }
                }
